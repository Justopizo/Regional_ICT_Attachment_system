...
// Only allow Registry admin to access this page
if (!isLoggedIn() || getUserRole() !== 'registry') {
...
$applications = getForwardedApplications('registry');
$accepted_applications = getApplicationsByDepartment('Registry');
$error = '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_status'])) {
    ...
    if (updateApplicationStatus($application_id, $status, $feedback)) {
        header("Location: registry_dashboard.php?success=Status updated successfully");
        exit();
    } else {
...
<head>
    ...
    <title>Registry Dashboard - Kakamega ICT Authority</title>
    ...
    <div class="dashboard-container">
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li class="active"><a href="registry_dashboard.php"><i class="fas fa-home"></i> Home</a></li>
        ...
        <div class="main-content">
            <div class="header">
                <h1>Registry Administrator Dashboard</h1>
                <div class="user-info">
            ...
            <div class="dashboard-section">
                ...
                <div class="card">
                    <?php if (empty($applications)): ?>
                        <p>No applications have been forwarded to Registry department at this time.</p>
                    <?php else: ?>
                            ...
                            <?php foreach ($applications as $application): ?>
                                <div class="application-item">
                                    ...
                                    <div class="application-actions">
                                        ...
                                        <form action="registry_dashboard.php" method="POST" class="inline-form">
            ...
            <div class="dashboard-section">
                ...
                <div class="card">
                    <?php if (empty($accepted_applications)): ?>
                        <p>No accepted applications in Registry department at this time.</p>
                    <?php else: ?>
                        <div class="applications-list">
