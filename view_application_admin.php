...
<body>
    ...
    <div class="container">
        <div class="application-details">
            <h2>Student Attachment Application Details</h2>
            ...
            <div class="detail-row">
                ...
                <div class="detail-value"><?php echo htmlspecialchars($application['phone'] ?? 'N/A'); ?></div>
            </div>
            ...
            <div style="margin-top: 20px;">
                <a href="review_applications.php" class="btn">Back to Applications</a>
            </div>
        </div>
    </div>
